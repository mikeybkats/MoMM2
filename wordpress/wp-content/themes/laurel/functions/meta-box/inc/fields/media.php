	...
	public static function admin_enqueue_scripts()
	{
		...
		if ( ! $wp_scripts->get_data( 'rwmb-media', 'data' ) )
		{
			wp_localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
				'add'                => apply_filters( 'rwmb_media_add_string', _x( '+ Add Media', 'media', 'laurel' ) ),
				'single'             => apply_filters( 'rwmb_media_single_files_string', _x( ' file', 'media', 'laurel' ) ),
				'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', _x( ' files', 'media', 'laurel' ) ),
				'remove'             => apply_filters( 'rwmb_media_remove_string', _x( 'Remove', 'media', 'laurel' ) ),
				'edit'               => apply_filters( 'rwmb_media_edit_string', _x( 'Edit', 'media', 'laurel' ) ),
				'view'               => apply_filters( 'rwmb_media_view_string', _x( 'View', 'media', 'laurel' ) ),
				'noTitle'            => _x( 'No Title', 'media', 'laurel' ),
				'loadingUrl'         => RWMB_URL . 'img/loader.gif',
				'extensions'         => self::get_mime_extensions(),
				'select'             => apply_filters( 'rwmb_media_select_string', _x( 'Select Files', 'media', 'laurel' ) ),
				'or'                 => apply_filters( 'rwmb_media_or_string', _x( 'or', 'media', 'laurel' ) ),
				'uploadInstructions' => apply_filters( 'rwmb_media_upload_instructions_string', _x( 'Drop files here to upload', 'media', 'laurel' ) ),
			) );
		}
	}
