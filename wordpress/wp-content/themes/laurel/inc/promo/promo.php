		...
		<div class="sp-row">
			...
			<div class="sp-col-4">
				<div class="promo-item" style="background-image:url(<?php if(get_theme_mod('laurel_promo2_image')) { echo get_theme_mod('laurel_promo2_image'); } else { echo get_template_directory_uri() . '/img/slider-default.png'; } ?>)">
					<?php if(get_theme_mod('laurel_promo2_url')) : ?><a href="<?php echo esc_url(get_theme_mod('laurel_promo2_url')); ?>" class="promo-link newsletterButton"></a><?php endif; ?>
					<div class="promo-overlay">
          ...
          <?php if(get_theme_mod('laurel_promo3_url')) : ?>
<a href="<?php echo esc_url(get_theme_mod('laurel_promo3_url')); ?>"<?php 
echo esc_url(get_theme_mod('laurel_promo3_url')); ?> class="promo-link"></a><?php endif; ?>
					<div class="promo-overlay">
