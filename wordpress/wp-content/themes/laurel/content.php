...
<!-------------- //post author and social bar ---------> 
	...
	<div class="post-meta">
		...
		<div class="meta-left">
			...
			<span class="author"><span class="by"><?php esc_html_e( 'By', 'laurel' ); ?></span> <?php the_author_posts_link(); ?></span>
			<?php endif; ?>
	...
	<div class="post-entry post-custom<?php if(get_theme_mod('laurel_post_summary') == 'full' || is_single()) : else : ?>is-excerpt<?php endif; ?>">
